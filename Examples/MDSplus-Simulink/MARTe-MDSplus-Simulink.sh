...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$CODE_DIRECTORY/GAMs/MarteTestGAM/${TARGET}/
...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$CODE_DIRECTORY/Interfaces/MDSInterface/${TARGET}/
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$CODE_DIRECTORY/IOGAMs/MDSDriver/${TARGET}/
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/mdsplus/mdsplus/lib64
...
#totalview $CODE_DIRECTORY/MARTe/${TARGET}/MARTe.ex $1
$CODE_DIRECTORY/MARTe/${TARGET}/MARTe.ex $1
#valgrind $CODE_DIRECTORY/MARTe/${TARGET}/MARTe.ex $1

#gdb --args $CODE_DIRECTORY/MARTe/${TARGET}/MARTe.ex $1
