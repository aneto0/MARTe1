...
operator== (const std::type_info& arg) const {
    return (&arg == this) || (rtai_strcmp(name(), arg.name()) == 0);
}
...
const void *origin;
    ...
    adjust_pointer(const void *base, ptrdiff_t offset) {
        //rt_printk("@adjust_pointer and base=%p and offset=%d\n", base, offset);
...
namespace __cxxabiv1 {
    ...
    {
        //rt_printk("src_ptr=%p\n", src_ptr);
        //rt_printk("src_type=%p\n", src_type);
        //rt_printk("dst_type=%p\n", dst_type);
        //rt_printk("src2dst=%d\n", src2dst);
        ...
        //rt_printk("vtable_prefix = %p\n", prefix);
        
        const void *whole_ptr =
        adjust_pointer <void> (src_ptr, prefix->whole_object);
        //rt_printk("whole_ptr = %p\n", whole_ptr);
        const __class_type_info *whole_type = prefix->whole_type;
        __class_type_info::__dyncast_result result;
        
        //rt_printk("whole_type = %p\n", whole_type);
        
        //rt_printk("*********************************************\n");
        //rt_printk("*********************************************\n");
        //rt_printk("*********************************************\n");
        //rt_printk("src2dst = %p\n", &src2dst);
        //rt_printk(" __class_type_info::__contained_public = %p\n",  __class_type_info::__contained_public);
        //rt_printk("dst_type = %p\n", dst_type);
        //rt_printk("whole_ptr = %p\n", whole_ptr);
        //rt_printk("src_type = %p\n", src_type);
        //rt_printk("src_ptr = %p\n", src_ptr);
