...
/** 
 * @file
 * DDBOutputInterface class definition.
 */
#if !defined (DDBOUTPUTINTERFACE_H)
#define DDBOUTPUTINTERFACE_H

#include "DDBInterface.h"

/** The DDBOutputInterface used by GAMs. */
class DDBOutputInterface: public DDBInterface{
public:
