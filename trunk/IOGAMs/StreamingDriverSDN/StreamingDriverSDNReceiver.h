 ...
 *
**/
#ifndef STREAMINGDRIVERSDN_REC_H_
#define STREAMINGDRIVERSDN_REC_H_
...
OBJECT_DLL(StreamingDriverSDNReceiver)

class StreamingDriverSDNReceiver: public GenericAcqModule{

OBJECT_DLL_STUFF(StreamingDriverSDNReceiver)
...
private:
    ...
    /** The id of the SDN consumer thread*/
    TID       receiverSDNThreadID;
    ...
    SDNSocketReceiver receiverSDNSocket;
...
public:
    ...
    /** Constructor. */
    StreamingDriverSDNReceiver();

    /** Destructor */
    virtual ~StreamingDriverSDNReceiver();

    friend void StreamingDriverReceiverThread(void *args);
    friend void StreamingDriverSDNReceiverThread(void *args);
