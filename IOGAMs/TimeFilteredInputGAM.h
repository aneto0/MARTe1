...
#ifndef TIMEFILTEREDINPUTGAM_H_
#define TIMEFILTEREDINPUTGAM_H_
...
OBJECT_DLL(TimeFilteredInputGAM)

class TimeFilteredInputGAM: public FilteredInputGAM{
    
    OBJECT_DLL_STUFF(TimeFilteredInputGAM)
