...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$CODE_DIRECTORY/IOGAMs/SDNDriver/${TARGET}/
...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$SDNDIR/target/lib/

export SDN_TOPIC_PATH=$SDNDIR/src/main/resources/
