...
public:
    ...
    /**
     * Check if it's possible that a thread can unlock the mutex locked by another thread. This should be possible.
    ...
    /**
     * Check what happen when a thread were killed while it locks a mutex. 
