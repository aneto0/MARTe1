...
bool BufferedStreamTest::TestReadAndWrite(const char *stringToRead, const char *stringToWrite){
	SimpleBufferedStream myStream;
	myStream.doubleBuffer=True;
...
bool BufferedStreamTest::TestSeek(const char *stringToRead, const char *stringToWrite){
	SimpleBufferedStream myStream;
...
bool BufferedStreamTest::TestSwitch(const char* onStream1, const char* onStream2){
	SimpleBufferedStream myStream;
