...
bool BitSetToIntegerTest::TestBitSetToBitSet(){
	...
	dPointer=dest;
	test=(int32)0xf10;
	BitSetToBitSet(dPointer, destShift, destSize, true, sPointer, sourceShift, sourceSize, false);
	if(dest[3]!=test){
		return False;
	}
	...
	dPointer=dest;
	test=(int32)0x10;
	BitSetToBitSet(dPointer, destShift, destSize, false, sPointer, sourceShift, sourceSize, true);
	if(dest[3]!=test){
		return False;
	}
	...
	test=(int32)0x310;
	BitSetToBitSet(dPointer8, destShift, destSize, false, sPointer8, sourceShift, sourceSize, false);
	if(dest[3]!=test){
		return False;
	}
	...
	BitSetToBitSet(dPointer64, destShift, destSize, true, sPointer64, sourceShift, sourceSize, true);
	if(dest[1]!=test){
		return False;
	}
