...
bool DoubleIntegerTest::TestShift(){
	...
	//left shift.
	if((sbit64 << 3) != 0x8000000000000000){
		return False;
	}
...
/////////////Subtraction
	...
	if((int32)(ubit64.upper)!=sbit64.upper || ubit64.lower != (uint32)sbit64.lower || ubit64.upper != 0 || sbit64.upper != 0){
		return False;
	}
	...
	if((int32)(test1.upper)!=test2.upper || test1.lower != (uint32)test2.lower || test1.upper != 1 || test2.upper != 1){
		return False;
	}
	...
	if((int32)(test1.upper)!=test2.upper || test1.lower != (uint32)test2.lower || test1.upper != 0 || test2.upper != 0){
		return False;
	}
...
/////////////Sum
	...
	if((int32)(ubit64.upper)!=sbit64.upper || ubit64.lower != (uint32)sbit64.lower || ubit64.upper != 1 || sbit64.upper != 1){
		return False;
	}
