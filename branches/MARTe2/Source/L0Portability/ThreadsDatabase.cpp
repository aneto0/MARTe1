...
bool ThreadsDatabaseNewEntry(ThreadInformation *threadInfo){
    ...
    if(index   >= ThreadsDatabase::maxNOfEntries) index -= ThreadsDatabase::maxNOfEntries;
...
bool ThreadsDatabaseGetInfo(ThreadInformation &threadInfoCopy, int32 n, TID threadId){
    if(n>0){
