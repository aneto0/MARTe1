...
extern "C" {
    ...
    */
    void *MemoryMalloc(uint32 size,MemoryAllocationFlags allocFlags=MemoryStandardMemory);
    ...
    */
    bool MemoryAllocationStatistics(uint32 &size, uint32 &chunks, TID tid = (TID)0xFFFFFFFF);
