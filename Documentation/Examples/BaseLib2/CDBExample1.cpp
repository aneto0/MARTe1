    ...
    bool ObjectLoadSetup(ConfigurationDataBase &cdb,StreamInterface *err){
        ...
        if(cdb->GetArrayDims(arraySize, arrayDimension, "MyFloatArray")){
            if(arrayDimension == 1){
                ...
                if(!cdb->ReadArray(myFloatArray, CDBTYPE_float, arraySize, arrayDimension, "MyFloatArray")){
        ...
        arraySize[0] = 0;
        arraySize[1] = 0;
        if(cdb->GetArrayDims(arraySize, arrayDimension, "MyFloatMatrix")){
            if(arrayDimension == 2){
                ...
                //Do the actual reading of values
                if(!cdb->ReadArray(myFloatMatrix, CDBTYPE_float, arraySize, arrayDimension, "MyFloatMatrix")){
        ...
        if(cdb->GetArrayDims(arraySize, arrayDimension, "MyStringArray")){
            if(arrayDimension == 1){
                ...
                //Do the actual reading of values
                if(!cdb->ReadArray(myStringArray, CDBTYPE_FString, arraySize, arrayDimension, "MyStringArray")){
